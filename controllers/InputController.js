...
const saveChatbotInput = async (req, res, next) => {
  ...
  const clientInput = {
    ...
    desc: req.body.customProperties.service_description[0].substring(2, -2),
    date: req.body.customProperties.service_date[0].substring(3, -3),
    location: req.body.customProperties.service_location[0].substring(2, -2),
    terms: "",
    ...
    service_type: req.body.customProperties.service_type[0].substring(2, -2),
    staff_count: req.body.customProperties.staff_count[0].substring(2, -2),
    service_time: req.body.customProperties.service_time[0].substring(2, -2),
